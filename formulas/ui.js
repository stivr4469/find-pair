        ...
        '<div class="view-enter" style="max-width:600px;margin:0 auto;padding-bottom:80px;">',
          '<div class="game-area" style="padding:22px 20px;">',
            ...
            '<div style="height:5px;background:var(--faint);border-radius:3px;margin-bottom:14px;overflow:hidden;">',
              '<div style="height:100%;width:100%;background:var(--accent);border-radius:0;transform:scaleX(' + (total > 0 ? (qIndex / total).toFixed(3) : 0) + ');transform-origin:left center;transition:transform var(--dur-slow) var(--ease-out);"></div>',
            '</div>',
        ...
        '<div class="game-area" style="padding: 22px 20px;">',
          ...
          '">',
            '<div style="',
              ...
              'background: var(--accent);',
              'border-radius: 0;',
              'transform: scaleX(' + (total > 0 ? (qIndex / total).toFixed(3) : 0) + ');',
