...
function displayAdvancedSettings_tren() {
    ...
    contentArea.innerHTML = `
        <div class="settings-container"> <h3>Настройки тренировки (A2)</h3> <div class="setting-group"> <h4>Глаголы:</h4> <div id="verbs-settings-tren"> ${verbs.map(verb => `<label><input type="checkbox" name="verb" value="${verb}" checked> ${verb}</label>`).join('')}
