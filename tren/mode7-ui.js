...
function showMode7ResultsUI() {
    ...
    contentArea.innerHTML = `
        <div class="results-container view-enter"> <h3>Результаты</h3> <div class="final-score">${correct} из ${total} (${percentage}%)</div> <div class="final-message">${message}</div> <button class="restart-button" onclick="restartMode7()">Ещё раз</button> <button class="menu-button" onclick="showMainMenu()">Меню</button> </div> `;
}
